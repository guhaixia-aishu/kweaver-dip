...
export const businessMenuItems: BusinessMenuItem[] = [
  ...
  {
    key: 'aievla',
    icon: 'icon-effect-evaluation',
    labelKey: 'routes.businessMenu.aiEvaluation',
    children: [
      {
        key: 'board',
        labelKey: 'routes.businessMenu.board',
        path: buildBusinessNetworkPath('/aievla/board'),
        page: {
          type: 'micro-app',
          app: {
            name: 'board',
      ...
      {
        key: 'evaluation-data',
        labelKey: 'routes.businessMenu.evaluationData',
        path: buildBusinessNetworkPath('/aievla/evaluation-data'),
        page: {
          type: 'micro-app',
          app: {
      ...
      {
        key: 'indicator',
        labelKey: 'routes.businessMenu.indicator',
        path: buildBusinessNetworkPath('/aievla/indicator'),
        page: {
          type: 'micro-app',
          app: {
            name: 'indicator',
      ...
      },
      {
        ...
        labelKey: 'routes.businessMenu.effectEvaluation',
        path: buildBusinessNetworkPath('/aievla/effect-evaluation'),
        page: {
          type: 'micro-app',
          app: {
