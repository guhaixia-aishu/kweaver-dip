...
import (
	...
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/ad_rec"
	adpAgentFactory "github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/adp_agent_factory/impl"
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/af_sailor_agent"
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/auth_service"
	basicSearch "github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/basic_search/impl"
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/configuration_center"
	cp_proxy "github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/copilot_helper"
	...
	subjectModel "github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/es_subject_model/impl"
	...
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/gorm/knowledge_network"
	hydra "github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/hydra/v6"
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/knowledge_build"
	ad_proxy "github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/knowledge_network"
	...
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/self"
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/user_management"
	"github.com/kweaver-ai/kweaver-dip/chat-data/sailor-service/adapter/driven/virtualization_engine"
