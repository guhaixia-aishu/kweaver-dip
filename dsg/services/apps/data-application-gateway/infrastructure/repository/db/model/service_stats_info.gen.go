...
type ServiceStatsInfo struct {
	...
	ApplyNum   uint64    `gorm:"column:apply_num;type:bigint(20) unsigned;not null" json:"apply_num"`                      // 申请数
	PreviewNum uint64    `gorm:"column:preview_num;type:bigint(20) unsigned;not null" json:"preview_num"`                  // 预览数
