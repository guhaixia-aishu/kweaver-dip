...
func (h *hydra) Introspect(ctx context.Context, token string) (info Ihydra.TokenIntrospectInfo, err error) {
	...
	resp, err := h.client.Do(req.WithContext(newCtx))
	if err != nil {
...
func (h *hydra) Delete(id string) error {
	return fmt.Errorf("Delete method is not implemented")
}

func (h *hydra) GetClientNameById(ctx context.Context, id string) (string, error) {
	return "", fmt.Errorf("GetClientNameById method is not implemented")
}

func (h *hydra) Register(clientID string, clientSecret string) (string, error) {
	return "", fmt.Errorf("Register method is not implemented")
}

func (h *hydra) Update(clientID string, clientSecretOld string, clientSecretNew string) error {
	return fmt.Errorf("Update method is not implemented")
}
