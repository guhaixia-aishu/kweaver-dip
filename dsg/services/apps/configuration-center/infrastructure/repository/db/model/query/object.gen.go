...
func newObject(db *gorm.DB, opts ...gen.DOOption) object {
	...
	_object.ID = field.NewString(tableName, "id")
	_object.Name = field.NewString(tableName, "name")
	_object.PathID = field.NewString(tableName, "path_id")
	_object.Path = field.NewString(tableName, "path")
	_object.Type = field.NewInt32(tableName, "type")
	_object.Attribute = field.NewString(tableName, "attribute")
...
type object struct {
	...
	ALL       field.Asterisk
	ID        field.String // 对象ID
	Name      field.String // 对象名称
	PathID    field.String // 路径ID
	Path      field.String // 路径
	Type      field.Int32  // 类型
	Attribute field.String // 属性信息：包括简称、机构编码、信用代码等
	CreatedAt field.Time   // 创建时间
	UpdatedAt field.Time   // 更新时间
	DeletedAt field.Field  // 删除时间(逻辑删除)
	DeptTag   field.String
...
func (o *object) updateTableName(table string) *object {
	...
	o.PathID = field.NewString(table, "path_id")
	o.Path = field.NewString(table, "path")
	o.Type = field.NewInt32(table, "type")
	o.Attribute = field.NewString(table, "attribute")
...
func (o *object) WithContext(ctx context.Context) IObjectDo { return o.objectDo.WithContext(ctx) }
...
func (o *object) fillFieldMap() {
	...
	o.fieldMap["path_id"] = o.PathID
	o.fieldMap["path"] = o.Path
	o.fieldMap["type"] = o.Type
	o.fieldMap["attribute"] = o.Attribute
...
type IObjectDo interface {
	...
	Session(config *gorm.Session) IObjectDo
	...
	Delete(...*model.Object) (info gen.ResultInfo, err error)
...
func (o objectDo) Session(config *gorm.Session) IObjectDo {
