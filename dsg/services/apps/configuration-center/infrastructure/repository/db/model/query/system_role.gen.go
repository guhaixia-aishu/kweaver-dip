...
func newSystemRole(db *gorm.DB, opts ...gen.DOOption) systemRole {
	...
	_systemRole.ID = field.NewString(tableName, "id")
	_systemRole.Name = field.NewString(tableName, "name")
	_systemRole.Color = field.NewString(tableName, "color")
	_systemRole.Icon = field.NewString(tableName, "icon")
	_systemRole.System = field.NewInt32(tableName, "system")
	_systemRole.CreatedAt = field.NewTime(tableName, "created_at")
	_systemRole.UpdatedAt = field.NewTime(tableName, "updated_at")
	_systemRole.DeletedAt = field.NewInt64(tableName, "deleted_at")
...
type systemRole struct {
	...
	Color     field.String // 角色背景色
	Icon      field.String // 角色图标
	System    field.Int32  // 是否是系统默认的角色1表示是默认，0表示不是
	CreatedAt field.Time   // 创建时间
	UpdatedAt field.Time   // 更新时间
	DeletedAt field.Int64  // 删除时间(逻辑删除)
...
func (s *systemRole) updateTableName(table string) *systemRole {
	...
	s.System = field.NewInt32(table, "system")
