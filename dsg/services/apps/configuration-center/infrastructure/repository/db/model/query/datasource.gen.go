...
func newDatasource(db *gorm.DB, opts ...gen.DOOption) datasource {
	...
	_datasource.DataSourceID = field.NewInt64(tableName, "data_source_id")
	_datasource.ID = field.NewString(tableName, "id")
	_datasource.InfoSystemID = field.NewString(tableName, "info_system_id")
	_datasource.Name = field.NewString(tableName, "name")
	_datasource.CatalogName = field.NewString(tableName, "catalog_name")
	_datasource.Type = field.NewInt32(tableName, "type")
	_datasource.Host = field.NewString(tableName, "host")
	_datasource.Port = field.NewInt32(tableName, "port")
	_datasource.Username = field.NewString(tableName, "username")
	_datasource.Password = field.NewString(tableName, "password")
	_datasource.DatabaseName = field.NewString(tableName, "database_name")
	_datasource.Schema = field.NewString(tableName, "schema")
	_datasource.SourceType = field.NewInt32(tableName, "source_type")
	_datasource.CreatedAt = field.NewTime(tableName, "created_at")
	_datasource.CreatedByUID = field.NewString(tableName, "created_by_uid")
	_datasource.UpdatedAt = field.NewTime(tableName, "updated_at")
	_datasource.UpdatedByUID = field.NewString(tableName, "updated_by_uid")
	_datasource.TypeName = field.NewString(tableName, "type_name")
...
type datasource struct {
	...
	ALL          field.Asterisk
	DataSourceID field.Int64  // 数据源雪花id
	ID           field.String // 数据源业务id
	InfoSystemID field.String // 信息系统id
	Name         field.String // 数据源名称
	CatalogName  field.String // 数据源catalog名称
	Type         field.Int32  // 数据库类型。已废弃，使用 type_name 替代
	Host         field.String // 连接地址
	Port         field.Int32  // 端口
	Username     field.String // 用户名
	Password     field.String // 密码
	DatabaseName field.String // 数据库名称
	Schema       field.String // 数据库模式
	SourceType   field.Int32  // 数据源类型 1:记录型、2:分析型
	CreatedAt    field.Time   // 创建时间
	CreatedByUID field.String
	UpdatedAt    field.Time // 更新时间
	UpdatedByUID field.String
	TypeName     field.String // 数据库类型名称
...
func (d *datasource) updateTableName(table string) *datasource {
	...
	d.DataSourceID = field.NewInt64(table, "data_source_id")
	d.ID = field.NewString(table, "id")
	d.InfoSystemID = field.NewString(table, "info_system_id")
	d.Name = field.NewString(table, "name")
	d.CatalogName = field.NewString(table, "catalog_name")
	...
	d.DatabaseName = field.NewString(table, "database_name")
	d.Schema = field.NewString(table, "schema")
	d.SourceType = field.NewInt32(table, "source_type")
	d.CreatedAt = field.NewTime(table, "created_at")
	d.CreatedByUID = field.NewString(table, "created_by_uid")
	d.UpdatedAt = field.NewTime(table, "updated_at")
	d.UpdatedByUID = field.NewString(table, "updated_by_uid")
...
func (d *datasource) fillFieldMap() {
	...
	d.fieldMap["data_source_id"] = d.DataSourceID
	d.fieldMap["id"] = d.ID
	d.fieldMap["info_system_id"] = d.InfoSystemID
	d.fieldMap["name"] = d.Name
	d.fieldMap["catalog_name"] = d.CatalogName
	...
	d.fieldMap["database_name"] = d.DatabaseName
	d.fieldMap["schema"] = d.Schema
	d.fieldMap["source_type"] = d.SourceType
	d.fieldMap["created_at"] = d.CreatedAt
	d.fieldMap["created_by_uid"] = d.CreatedByUID
	d.fieldMap["updated_at"] = d.UpdatedAt
	d.fieldMap["updated_by_uid"] = d.UpdatedByUID
