...
func newConfiguration(db *gorm.DB, opts ...gen.DOOption) configuration {
	...
	_configuration.Type = field.NewInt32(tableName, "type")
...
type configuration struct {
	...
	Key   field.String
	Value field.String
	Type  field.Int32 // 第三方地址类型，枚举：1：带路径；2：不带路径；
...
func (c *configuration) WithContext(ctx context.Context) IConfigurationDo {
	return c.configurationDo.WithContext(ctx)
}

func (c configuration) TableName() string { return c.configurationDo.TableName() }

func (c configuration) Alias() string { return c.configurationDo.Alias() }
