...
func newResource(db *gorm.DB, opts ...gen.DOOption) resource {
	...
	_resource.RoleID = field.NewString(tableName, "role_id")
	_resource.Type = field.NewInt32(tableName, "type")
	_resource.SubType = field.NewInt32(tableName, "sub_type")
	_resource.Value = field.NewInt32(tableName, "value")
...
func (r *resource) updateTableName(table string) *resource {
	...
	r.SubType = field.NewInt32(table, "sub_type")
...
func (r resourceDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IResourceDo {
