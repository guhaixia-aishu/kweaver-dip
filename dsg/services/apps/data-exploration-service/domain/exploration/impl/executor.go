...
func (e *ExplorationDomainImpl) generateSql(sql string, tableInfo exploration.MetaDataTableInfo, totalSample int32, field *exploration.ExploreField) (string, error) {
	if totalSample > 0 {
