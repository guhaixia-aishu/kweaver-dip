...
import (
	...
	"github.com/kweaver-ai/kweaver-dip/dsg/services/apps/data-exploration-service/domain/task_config"
...
func (e *ExplorationDomainImplV2) getReport(tx *gorm.DB, ctx context.Context, report *model.Report) (reportFormat exploration.ReportFormat, err error) {
...
func (e *ExplorationDomainImplV2) FormatExploreDataResult(response string) (map[string]map[string]any, error) {
...
func (e *ExplorationDomainImplV2) FormatExploreTimestampResult(response string) (map[string]string, error) {
...
func (e *ExplorationDomainImplV2) calculateItemScore(tx *gorm.DB, ctx context.Context, report *model.Report, reportFormat *exploration.ReportFormat) (err error) {
...
func (e *ExplorationDomainImplV2) calculateMetadataExploreScore(ctx context.Context, task *task_config.TaskConfigReq, code string) (*exploration.ExploreDetails, error) {
...
func (e *ExplorationDomainImplV2) calculateFieldExploreScore(tx *gorm.DB, ctx context.Context, task *task_config.TaskConfigReq, code string) (*exploration.ExploreFieldDetails, error) {
...
func (e *ExplorationDomainImplV2) calculateRowExploreScore(tx *gorm.DB, ctx context.Context, task *task_config.TaskConfigReq, code string) (*exploration.ExploreDetails, error) {
...
func (e *ExplorationDomainImplV2) calculateViewExploreScore(tx *gorm.DB, ctx context.Context, task *task_config.TaskConfigReq, code string) (*exploration.ExploreDetails, error) {
...
func (e *ExplorationDomainImplV2) GetDataExploreReport(ctx context.Context, req *exploration.CodePathParam) (report *exploration.ReportFormat, err error) {
...
func (e *ExplorationDomainImplV2) GetDataExploreReportByParam(ctx context.Context, req *exploration.ReportSearchReq) (report *exploration.ReportFormat, err error) {
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
...
// GetDataExploreReport 根据表或任务id获取最新报告
func (e *ExplorationDomainImplV2) GetDataExploreThirdPartyReportByParam(ctx context.Context, req *exploration.ReportSearchReq) (report *exploration.ReportFormat, err error) {
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
	if req.TableId == nil && req.TaskId == nil {
		return nil, errorcode.Detail(errorcode.PublicInvalidParameter, "table_id和task_id不能同时为空")
...
func (e *ExplorationDomainImplV2) GetDataExploreReportListByParam(ctx context.Context, req *exploration.ReportListSearchReq) (result *exploration.ListReportRespParam, err error) {
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
...
func (e *ExplorationDomainImplV2) GetDataExploreThirdPartyReportListByParam(ctx context.Context, req *exploration.ReportListSearchReq) (result *exploration.ListReportRespParam, err error) {
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
...
func (e *ExplorationDomainImplV2) GetLatestDataExploreReportList(ctx context.Context, req *exploration.ReportListReq) (result *exploration.ReportListResp, err error) {
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
	if req.ThirdParty {
...
func (e *ExplorationDomainImplV2) GetFieldDataExploreReport(ctx context.Context, req *exploration.FieldReportSearchReq) (*exploration.FieldReportResp, error) {
	var err error
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
...
func (e *ExplorationDomainImplV2) getTimestampReport(tx *gorm.DB, ctx context.Context, report *model.Report) ([]*exploration.FieldInfo, error) {
...
func (e *ExplorationDomainImplV2) GetDataExploreReports(ctx context.Context, req *exploration.GetDataExploreReportsReq) (*exploration.GetDataExploreReportsResp, error) {
...
func (e *ExplorationDomainImplV2) calculateThirdPartyFieldExploreScore(tx *gorm.DB, ctx context.Context, report *model.ThirdPartyReport, rules []exploration.RuleInfo) (*exploration.ExploreFieldDetails, error) {
	var filedCompletenessCount, filedStandardizationCount, filedUniquenessCount, filedAccuracyCount int
	fieldDetail := &exploration.ExploreFieldDetails{}
	fieldCompletenessScore := float64(0)
	fieldStandardizationScore := float64(0)
...
func (e *ExplorationDomainImplV2) getThirdPartyReport(tx *gorm.DB, ctx context.Context, report *model.ThirdPartyReport, result *exploration.ThirdPartyDataExploreResultMsg) (reportFormat exploration.ReportFormat, err error) {
	reportFormat.Code = report.Code
	reportFormat.TaskId = fmt.Sprintf("%d", report.TaskID)
	reportFormat.Version = *report.TaskVersion
	reportFormat.ExploreType = *report.ExploreType
...
func (e *ExplorationDomainImplV2) calculateThirdPartyReportScore(tx *gorm.DB, ctx context.Context, report *model.ThirdPartyReport, result *exploration.ThirdPartyDataExploreResultMsg, reportFormat *exploration.ReportFormat) (err error) {
	completenessScore := float64(0)
	standardizationScore := float64(0)
	uniquenessScore := float64(0)
	accuracyScore := float64(0)
